...
function ProfessionalConnectorSection({ currentUserId }) {
  ...
  return (
    <div>
      ...
      <p className="pl-hint" style={{ marginBottom: 12 }}>
        Scegli un locale con una serata attiva ora, tocca chi è check-in in questo momento per
        aprire la chat diretta — da lì puoi attivare "PR professionista" per chi gestisce davvero
        più tavoli stasera, così può diventare Connector di più tavoli senza doversi sedere a
        nessuno di essi.
      </p>
